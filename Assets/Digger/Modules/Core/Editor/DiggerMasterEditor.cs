...
namespace Digger.Modules.Core.Editor
{
    ...
    public class DiggerMasterEditor : UnityEditor.Editor
    {
        ...
        private void OnInspectorGUIClearButtons()
        {
            ...
            if (GUILayout.Button(new GUIContent("Save meshes as assets", "This can be done automatically before scene save by enabling it in Digger settings."), GUILayout.Height(30))) {
                SaveMeshesAsAssets();
            }
        ...
        public static void CheckDiggerVersion()
        {
            ...
            if (warned) {
                ...
                EditorUtility.DisplayDialog("Digger successfully updated",
                        ...
                        "RELEASE NOTE:\n\n" +
                        "- new 'Auto save meshes as asset' setting, enabled by default. You can disable it in Digger settings.\n\n" +
                        "- new shaders with improved triplanar mapping and performance for standard pipeline, URP (12 and 14) and HDRP (12 and 14)\n\n" +
                        "- new TextureDetector script in Demo folder\n\n" +
                        "- bug fixes",
                        "Ok");
            }
        }
