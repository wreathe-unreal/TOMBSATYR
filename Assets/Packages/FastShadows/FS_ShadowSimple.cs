...
public class FS_ShadowSimple : MonoBehaviour {
	...
	public float shadowHoverHeight = .2f;
	public LayerMask layerMask = ~0;
	public Material shadowMaterial;
	public bool isStatic = false;
	
	public bool useLightSource = false;
	public GameObject lightSource = null;
	public Vector3 lightDirection = new Vector3(0f, -1, 0f);
	public bool isPerspectiveProjection = false;
	public bool doVisibilityCulling = false;
