Shader "Digger/Mesh/Diffuse-Pass3" {
    Properties {
    ...
    SubShader {
        ...
        CGPROGRAM
        #pragma surface surf Standard decal:add vertex:SplatmapVert finalcolor:SplatmapFinalColor finalgbuffer:SplatmapFinalGBuffer addshadow fullforwardshadows
        ...
        #include "TriplanarMeshSplatmapCommon.cginc"
        ...
        void SplatmapVert(inout appdata_full v, out Input data)
        {
            ...
            data.bary = v.color.xyz;
            data.splat_control = v.tangent;
